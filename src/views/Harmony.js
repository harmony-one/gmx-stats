...
function Harmony(props) {
  ...
  const params = { from, to, groupPeriod, chainName: 'harmony' }

  const [fundingRateData, fundingRateLoading] = useFundingRateData(params)

  const [volumeData, volumeLoading] = useVolumeData(params)
  const [totalVolumeData, totalVolumeLoading] = useVolumeData({ chainName: 'harmony' })
  ...
  const [totalFeesData, totalFeesLoading] = useFeesData({ chainName: 'harmony' })
  ...
  const [totalGlpData, totalGlpLoading] = useGlpData({ chainName: 'harmony' })
  ...
  const [totalTradersData, totalTradersLoading] = useTradersData({ chainName: 'harmony' })
  ...
  const [totalUsersData, totalUsersLoading] = useUsersData({ chainName: 'harmony' })
    ...
    <div className="Home">
      <div className="page-title-section">
        <div className="page-title-block">
          <h1>GMX V1 Analytics / Harmony</h1>
